...
# THE TRADING JOURNAL FOR main BYBIT DEMO account
...
journal_path = journal_folder/'bybit_main_demo_journal.csv'
#  API credentials:
...
def fetch_closed_trades(days_back: int = 3) -> list:
    """
